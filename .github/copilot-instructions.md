...
- [ ] Linting completed — score: 10/10 (command: `<insert command>`)
- [ ] Tests passing locally — command: `<insert command>`
- [ ] Static analysis/type checks passing — command: `<insert command>`
- [ ] Formatting applied — command: `<insert command>`
...
- [ ] Changelog/version notes updated (if user-facing changes)
- [ ] Backward compatibility verified or migration guide provided
- [ ] Human review performed on LLM-generated code
